        ...
        const emailContents: EmailContent[] = [
            {
                ...
                language: 'en',
                lang_dictionary: [
                    { label: 'charge_soon_email_subject', traduction: 'Your monthly Iurest service will end soon' },
            ...
            },
            {
                ...
                language: 'es',
                lang_dictionary: [
                    { label: 'charge_soon_email_subject', traduction: 'Tu periodo mensual de Iurest terminará pronto' },
