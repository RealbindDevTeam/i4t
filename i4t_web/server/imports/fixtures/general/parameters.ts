...
export function loadParameters() {
    if (Parameters.find().cursor.count() === 0) {
        const parameters: Parameter[] = [
            ...
            { _id: '9100', name: 'payu_test_state', value: 'PENDING', description: 'Test state for payu payment transaction' },
            { _id: '9200', name: 'payu_reference_code', value: 'MONP_', description: 'Prefix for reference code on payu transactions' },
